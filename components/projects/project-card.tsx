...
export function ProjectCard({ project }: { project: ProjectFrontmatter }) {
  return (
    <MotionLift>
      <article className="group relative flex min-h-[22rem] flex-col overflow-hidden rounded-[var(--radius-lg)] border border-border bg-surface p-6 transition-colors hover:border-accent/50 sm:p-8">
